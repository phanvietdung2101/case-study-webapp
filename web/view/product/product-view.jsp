    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-6">
            <div class="card bg-light mb-3">
                <div class="card-body">
                    <a href="${product.getImage()}" data-toggle="modal" data-target="#productModal">
            ...
            <div class="card bg-light mb-3">
                <div class="card-body">
                    ...
                    <form method="get" action="/index">
                        ...
                        <a href="/index?action=add_to_cart&product_id=${product.getId()}" type="submit" class="btn btn-success btn-lg btn-block text-uppercase">
